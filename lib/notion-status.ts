...
// DIOCESE_ORDER와 동일한 순서로 유지 (2026-09-16 노션 수치 기준, 군종은 노션 미등록)
const FALLBACK_DATA: DioceseChartDatum[] = [
  { name: "원주교구", 현재인원: 850, 목표인원: 2000, color: "#7E1A37" },
  { name: "의정부교구", 현재인원: 1689, 목표인원: 10000, color: "#1D2974" },
  { name: "수원교구", 현재인원: 9581, 목표인원: 30000, color: "#0092D4" },
  { name: "군종교구", 현재인원: 1860, 목표인원: 3000, color: "#446B33" },
  { name: "마산교구", 현재인원: 430, 목표인원: 3000, color: "#50B14A" },
  { name: "전주교구", 현재인원: 1122, 목표인원: 4000, color: "#AE2243" },
  { name: "제주교구", 현재인원: 1704, 목표인원: 2000, color: "#AC995E" },
  { name: "인천교구", 현재인원: 7631, 목표인원: 10000, color: "#EE7836" },
  { name: "광주교구", 현재인원: 1198, 목표인원: 4800, color: "#D92E16" },
  { name: "대전교구", 현재인원: 2000, 목표인원: 2000, color: "#870023" },
  { name: "대구교구", 현재인원: 3497, 목표인원: 7000, color: "#AE0042" },
  { name: "춘천교구", 현재인원: 1000, 목표인원: 1000, color: "#CE6D4E" },
  { name: "청주교구", 현재인원: 627, 목표인원: 3000, color: "#005BAC" },
  { name: "부산교구", 현재인원: 4768, 목표인원: 7000, color: "#6C6E72" },
  { name: "안동교구", 현재인원: 1000, 목표인원: 1000, color: "#0B76B8" },
];
