...
export default function SliderItem00() {
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      />
      <h2 className="heading02b text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 text-center text-5xl max-[1080px]:text-3xl animate-bottomUp opacity-0 w-full">
        2027 WYD 교구대회 <br />
        COMING SOON
      </h2>
